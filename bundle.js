...
(function main() {
  ...
  let canvas = new __WEBPACK_IMPORTED_MODULE_9__Canvas__["a" /* Canvas */](MAX_WIDTH, MAX_HEIGHT);
  let context = canvas.getContext();
  let sound = new __WEBPACK_IMPORTED_MODULE_6__Sound__["a" /* Sound */]();
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__attach_event_handlers__["a" /* attachEventHandlers */])(score, newGame);
  ...
  function handleShot(things, tank) {
    ...
    let bullet = new __WEBPACK_IMPORTED_MODULE_3__Bullet__["a" /* Bullet */](tip.x, tip.y, direction, tank);
    things.push(bullet);
    tank.handleShot();
  }
  ...
  function newGame() {
    ...
    tanks[thisPlayer].setControlsMap(__WEBPACK_IMPORTED_MODULE_7__CONTROL_CONFIG__["a" /* CONTROL_CONFIG */][0]);
